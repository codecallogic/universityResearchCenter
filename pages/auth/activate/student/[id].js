  ...
  return (
    <div className="activate-container">
      <div className="activate">
        ...
        <button type="submit" className="activate-button" onClick={activateAccount}>{!activating && <span>Activate Account</span>}{activating && <div className="loading-activate"><span></span><span></span><span></span></div>}</button>
